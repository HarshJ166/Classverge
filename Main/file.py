...
root.title("file managing service")
root.config(background="#302F49")
...
lbl_heading = Label(root, text="File Management system",font=("bold",18),fg="gold2",bg='black')
lbl_heading.grid(row=1, column=1, pady=20, padx=100)
