...
def connect():
       conn = sqlite3.connect("C:/Users/Harsh Jajal/Documents/Classverge/Main/Staff.db")
       cur = conn.cursor()

       cur.execute("CREATE TABLE IF NOT EXISTS staff (id INTEGER PRIMARY KEY, name text, father_name text, mother_name text, \
...
def insert(name = " ", father_name =" ", mother_name =" ", address =" ", mobileno =" ", email_address =" ", date_of_birth =" ", gender =" "):
       ...
       cur.execute("INSERT INTO staff VALUES (NULL,?,?,?,?,?,?,?,?)", (name, father_name, mother_name, address , mobileno, email_address, date_of_birth, gender))
...
def update(id, name = " ", father_name =" ", mother_name =" ", address =" ", mobileno =" ", email_address =" ", date_of_birth =" ", gender =" "):
       ...
       cur.execute("UPDATE staff SET name = ? OR father_name = ? OR mother_name = ? OR address = ? OR mobileno = ? OR email_address = ? OR date_of_birth = ? OR gender = ?", \
...
def search(name = " ", father_name =" ", mother_name =" ", address =" ", mobileno =" ", email_address =" ", date_of_birth =" ", gender =" "):
       ...
       cur.execute("SELECT * FROM staff WHERE name = ? OR father_name = ? OR mother_name = ? OR address = ? OR mobileno = ? OR email_address = ? OR date_of_birth = ? \
