...
# Create a frame and set its background color
frame = tk.Frame(root, bg="#1A2238")
...
if __name__ == "__main__":  
    ...
    conn = sqlite3.connect(
        r'C:/Users/Harsh Jajal/Documents/Classverge/Main/Timetable-Management-System-master/files/timetable.db')
    ...
    font_attributes = ('Times New Roman', 20, 'bold')
    tk.Label( text="Faculty Panel", font=font_attributes,
         bg="#FF6A3d", fg="white", width=15, height=1).place(x=600, y=50)
    # Label2
    tk.Label(text="Faculty Update Panel", font=font_attributes,
             bg="#FF6A3d", fg="white", width=15, height=1).place(x=90, y=50)
    
    #Label3
    tk.Label(text="Add information in the following prompt!", font=('Times New Roman', 14, 'bold'),
         bg="#FF6A3d", fg="white", width=30, height=1).place(x=150, y=85)

    # Label4
    tk.Label(text="Faculty id:", font=font_attributes,
             bg="#FF6A3d", fg="white", width=10, height=1).place(x=100, y=130)
    # Entry1
    fid_entry = tk.Entry(
        subtk,
