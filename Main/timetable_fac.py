...
def fac_tt_frame(tt, f):
    ...
    legend_f = tk.Frame(tt, bg="#1A2238")
    ...
    table = tk.Frame(tt,bg="#1A2238")
    table.pack()

    first_half = tk.Frame(table,bg="#1A2238")
    first_half.pack(side='left')

    recess_frame = tk.Frame(table,bg="#1A2238")
    recess_frame.pack(side='left')

    second_half = tk.Frame(table,bg="#1A2238")
...
if __name__ == "__main__":
    ...
    tt = tk.Tk()
    tt.config(bg = '#1A2238')
    tt.geometry('1000x650')
    tt.minsize(width=1000,height=650)
    tt.maxsize(width=1000,height=650)
    tt.title('Faculty Timetable')
    tt.iconbitmap('logo.ico')
    fac_tt_frame(tt, fini)

    fac_select_f = tk.Frame(tt, pady=25,bg = '#1A2238')
    fac_select_f.pack()
