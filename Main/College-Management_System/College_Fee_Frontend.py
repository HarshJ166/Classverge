...
class college_fee():
    def __init__(self, master):
        ...
        self.master.minsize(width=1400,height=750)
        self.master.maxsize(width=1400,height=750)
        ...
        College_Frame_2 = LabelFrame(College_Data_Frame, width=495, height=350, bg='#1A2238',fg="#F4DB7D" ,relief='ridge', bd=8,
        ...
        self.receipts_lbl = Label(College_Frame_1, text='Receipt No. : ', font=(
            'arial', 14, 'bold'), bg='#1A2238',fg="#FF6A3D")
