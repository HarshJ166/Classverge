...
class Library:
       ...
       def __init__(self, root):
              self.root = root
              self.root.title('College Library')
              self.root.geometry('1400x750')
              self.root.minsize(width=1400,height=750)
              self.root.maxsize(width=1400,height=750)
              self.root.config(bg = '#1A2238')
              ...
              Library_Main_Frame = Frame(self.root, bg = '#1A2238')
              Library_Main_Frame.grid()

              Library_Title_Frame_1 = Frame(Library_Main_Frame, width = 1350, bg = '#1A2238', relief = RIDGE, bd = 15, padx = 20)
              ...
              self.Library_lblTitle = Label(Library_Title_Frame_1, font = ('arial', 40, 'bold'), text ='\tLibrary Management System\t', \
                                            bg = '#1A2238',fg="#FF6A3D", padx = 13)
              self.Library_lblTitle.grid()

              btn_Frame = Frame(Library_Main_Frame, width = 1350, height = 50, relief = RIDGE, bd = 10, bg = '#1A2238')
              btn_Frame.pack(side = BOTTOM)

              Library_Detail_Frame = Frame(Library_Main_Frame, width = 1350, height = 100, relief = RIDGE, bd = 10, bg = '#1A2238')
              Library_Detail_Frame.pack(side = BOTTOM)

              Library_Data_Frame = Frame(Library_Main_Frame, width = 1350, height = 400, relief = RIDGE, bd = 15, bg = '#1A2238')
              Library_Data_Frame.pack(side = BOTTOM)

              Library_Frame_1 = LabelFrame(Library_Data_Frame, width = 800, height = 400, relief = RIDGE, bd = 10, bg = '#1A2238', \
                              text = "Library Membership Info:",fg="#F4DB7D", padx = 20, font = ('arial',15,'bold'))
              Library_Frame_1.pack(side = LEFT, padx = 3)

              Library_Frame_2 = LabelFrame(Library_Data_Frame, width = 550, height = 400, relief = RIDGE, bd = 10, bg = '#1A2238', \
                              text = "Book Details:",fg="#F4DB7D", padx = 20, font = ('arial',15,'bold'))
              ...
              btnsave_1 = Button(btn_Frame, text = 'SAVE', font = ('arial',15,'bold'), width = 10,bg="#9DAAF2",fg="Black", command = Insert)
              btnsave_1.grid(row = 0, column = 0, padx = 8, pady = 5,)
              btndisplay_2 = Button(btn_Frame, text = 'DISPLAY', font = ('arial',15,'bold'),bg="#9DAAF2",fg="Black", width = 10, command = Display)
              btndisplay_2.grid(row = 0, column = 1, padx = 8,)
              btnreset_3 = Button(btn_Frame, text = 'RESET', font = ('arial',15,'bold'),bg="#9DAAF2",fg="Black" ,width = 10, command = Reset)
              btnreset_3.grid(row = 0, column = 2, padx = 8,)
              btnupdate_4 = Button(btn_Frame, text = 'UPDATE', font = ('arial',15,'bold'),bg="#9DAAF2",fg="Black", width = 10, command = Update)
              ...
              btndelete_6 = Button(btn_Frame, text = 'DELETE', font = ('arial',15,'bold'),bg="#9DAAF2",fg="Black", width = 10, command = Delete)
              btndelete_6.grid(row = 0, column = 5, padx = 8,)
              btnexit_7 = Button(btn_Frame, text = 'EXIT', font = ('arial',15,'bold'), bg="#9DAAF2",fg="Black",width = 10, command = Exit)
